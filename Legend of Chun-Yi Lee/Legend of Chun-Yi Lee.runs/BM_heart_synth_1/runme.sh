...
HD_PWD='C:/Users/nthu-326/Documents/GitHub/HardwareDesignLabFP/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_heart_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BM_heart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BM_heart.tcl
