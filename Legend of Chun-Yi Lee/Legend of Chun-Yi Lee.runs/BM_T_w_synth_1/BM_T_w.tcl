...
set cached_ip [config_ip_cache -export -no_bom  -dir {C:/verilog project/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_T_w_synth_1} -new_name BM_T_w -ip [get_ips BM_T_w]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top BM_T_w -part xc7a35tcpg236-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix BM_T_w_ BM_T_w.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ BM_T_w_stub.v
 lappend ipCachedFiles BM_T_w_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ BM_T_w_stub.vhdl
 lappend ipCachedFiles BM_T_w_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ BM_T_w_sim_netlist.v
 lappend ipCachedFiles BM_T_w_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ BM_T_w_sim_netlist.vhdl
 lappend ipCachedFiles BM_T_w_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp BM_T_w.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips BM_T_w]
}

rename_ref -prefix_all BM_T_w_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef BM_T_w.dcp
