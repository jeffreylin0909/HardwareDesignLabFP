...
HD_PWD='C:/verilog project/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_T_w_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BM_T_w.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BM_T_w.tcl
