...
HD_PWD='C:/Users/nthu-326/Documents/GitHub/HardwareDesignLabFP/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BM_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BM_5.tcl
