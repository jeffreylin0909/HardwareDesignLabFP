...
HD_PWD='C:/verilog project/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_EECS_student_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BM_EECS_student.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BM_EECS_student.tcl
