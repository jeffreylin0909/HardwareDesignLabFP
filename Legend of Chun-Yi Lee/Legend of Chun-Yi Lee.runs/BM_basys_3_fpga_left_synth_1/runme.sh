...
HD_PWD='C:/verilog project/Legend of Chun-Yi Lee/Legend of Chun-Yi Lee.runs/BM_basys_3_fpga_left_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BM_basys_3_fpga_left.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BM_basys_3_fpga_left.tcl
