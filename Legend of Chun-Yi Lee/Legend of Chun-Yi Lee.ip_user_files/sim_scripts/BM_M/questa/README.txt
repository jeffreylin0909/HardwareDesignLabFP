...
#
# Generated by export_simulation on Tue Jan 09 16:57:16 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_M.sh' script.
...
./BM_M.sh -noclean_files

For more information on the script, please type './BM_M.sh -help'.
