...
#
# Generated by export_simulation on Thu Jan 11 16:09:03 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_basys_3_fpga_left.sh' script.

./BM_basys_3_fpga_left.sh -reset_run
...
./BM_basys_3_fpga_left.sh -noclean_files

For more information on the script, please type './BM_basys_3_fpga_left.sh -help'.
