...
#
# Generated by export_simulation on Thu Jan 11 09:00:36 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_8.sh' script.
...
./BM_8.sh -noclean_files

For more information on the script, please type './BM_8.sh -help'.
