...
#
# Generated by export_simulation on Thu Jan 11 08:58:19 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_3.sh' script.
...
./BM_3.sh -noclean_files

For more information on the script, please type './BM_3.sh -help'.
