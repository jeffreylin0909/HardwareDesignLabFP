...
#
# Generated by export_simulation on Thu Jan 11 08:12:54 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_colon.sh' script.

./BM_colon.sh -reset_run
...
./BM_colon.sh -noclean_files

For more information on the script, please type './BM_colon.sh -help'.
