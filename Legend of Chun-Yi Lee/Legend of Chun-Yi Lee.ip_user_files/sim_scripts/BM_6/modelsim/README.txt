...
#
# Generated by export_simulation on Thu Jan 11 08:59:43 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_6.sh' script.
...
./BM_6.sh -noclean_files

For more information on the script, please type './BM_6.sh -help'.
