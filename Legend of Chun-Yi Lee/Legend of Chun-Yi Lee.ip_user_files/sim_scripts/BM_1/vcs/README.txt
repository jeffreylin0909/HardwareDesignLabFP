...
#
# Generated by export_simulation on Thu Jan 11 08:57:26 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_1.sh' script.
...
./BM_1.sh -noclean_files

For more information on the script, please type './BM_1.sh -help'.
