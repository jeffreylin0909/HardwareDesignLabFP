...
#
# Generated by export_simulation on Tue Jan 09 16:56:39 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_G.sh' script.
...
./BM_G.sh -noclean_files

For more information on the script, please type './BM_G.sh -help'.
