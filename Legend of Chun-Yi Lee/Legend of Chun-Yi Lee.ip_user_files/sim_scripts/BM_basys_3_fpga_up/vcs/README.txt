...
#
# Generated by export_simulation on Thu Jan 11 16:08:21 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_basys_3_fpga_up.sh' script.

./BM_basys_3_fpga_up.sh -reset_run
...
./BM_basys_3_fpga_up.sh -noclean_files

For more information on the script, please type './BM_basys_3_fpga_up.sh -help'.
