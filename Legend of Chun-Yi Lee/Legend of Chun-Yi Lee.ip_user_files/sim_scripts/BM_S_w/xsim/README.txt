...
#
# Generated by export_simulation on Wed Jan 10 20:26:13 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_S_w.sh' script.
...
./BM_S_w.sh -noclean_files

For more information on the script, please type './BM_S_w.sh -help'.
