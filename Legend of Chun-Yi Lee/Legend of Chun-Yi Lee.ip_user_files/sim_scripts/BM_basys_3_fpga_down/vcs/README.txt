...
#
# Generated by export_simulation on Mon Jan 08 15:04:54 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_basys_3_fpga_down.sh' script.

./BM_basys_3_fpga_down.sh -reset_run
...
./BM_basys_3_fpga_down.sh -noclean_files

For more information on the script, please type './BM_basys_3_fpga_down.sh -help'.
