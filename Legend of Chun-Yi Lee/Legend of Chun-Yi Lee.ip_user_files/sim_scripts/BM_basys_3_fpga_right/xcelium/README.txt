...
#
# Generated by export_simulation on Thu Jan 11 16:09:44 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_basys_3_fpga_right.sh' script.

./BM_basys_3_fpga_right.sh -reset_run
...
./BM_basys_3_fpga_right.sh -noclean_files

For more information on the script, please type './BM_basys_3_fpga_right.sh -help'.
