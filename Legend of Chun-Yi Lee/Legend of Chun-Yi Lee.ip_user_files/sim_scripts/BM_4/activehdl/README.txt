...
#
# Generated by export_simulation on Thu Jan 11 08:58:46 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_4.sh' script.
...
./BM_4.sh -noclean_files

For more information on the script, please type './BM_4.sh -help'.
