...
#
# Generated by export_simulation on Thu Jan 11 09:00:08 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BM_7.sh' script.
...
./BM_7.sh -noclean_files

For more information on the script, please type './BM_7.sh -help'.
